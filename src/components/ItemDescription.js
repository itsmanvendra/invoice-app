...
export default function ItemDescription({ index, value, onInputChange, removeItem }) {
    ...
    return (
        <div className="flex flex-row justify-center items-center rounded-lg bg-gray-700 p-4 mt-2 border-2 border-gray-500">
                ...
                <div className="grid grid-cols-2 gap-2">
                    <div className="flex flex-col justify-stretch items-start">
                        ...
                        <input type="text" className="bg-zinc-800 text-white p-2 rounded-lg w-11/12"
                            ...
                            name="title"
                            value={value.title} onChange={(e) => onInputChange(index, e)} />
                    </div>
                    <div className="flex flex-col justify-stretch items-start">
                        ...
                        <input type="text" className="bg-zinc-800 text-white p-2 rounded-lg w-11/12"
                            ...
                            name="description"
                            value={value.description} onChange={(e) => onInputChange(index, e)}
                        />
                    </div>
                </div>
                <div className="grid grid-cols-3 gap-2">
                    <div className="flex flex-col justify-stretch items-start">
                        ...
                        <input type="text" className="bg-zinc-800 text-white p-2 rounded-lg w-11/12"
                            placeholder="5"
                            name="quantity"
                            value={value.quantity} onChange={(e) => onInputChange(index, e)}
                        />
                    </div>
                    <div className="flex flex-col justify-stretch items-start">
            ...
            <button className="p-2 mt-8 my-2 bg-red-900 text-gray-100 rounded-lg" onClick={() => removeItem(index) }>Delete</button>
        </div>
    )
}